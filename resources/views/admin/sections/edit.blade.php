...
@section('title', __('admin.edit_section'))

@section('content')

<div class="container py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="h3 mb-0 fw-bold text-primary">{{ __('admin.edit_section') }}</h1>
        ...
        <div class="card-body p-4 p-md-5">
            ...
            <form action="{{ route('admin.sections.update', $section->id) }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" class="form-control rounded-pill @error('name') is-invalid @enderror" id="name" name="name" value="{{ old('name', $section->name) }}" required>
                    @error('name')
                ...
                <div class="mb-4">
                    ...
                    <input type="number" class="form-control rounded-pill @error('max_students') is-invalid @enderror" id="max_students" name="max_students" value="{{ old('max_students', $section->max_students) }}" min="0" required>
                    @error('max_students')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
