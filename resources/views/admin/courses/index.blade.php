...
@section('title', __('admin.view_all_courses'))

@section('content')

<div class="container py-4">
<div class="d-flex justify-content-between align-items-center mb-4">
<h1 class="h3 mb-0 fw-bold text-primary">{{ __('admin.courses_list') }}</h1>
<a href="{{ route('admin.courses.create') }}" class="btn btn-outline-primary fw-bold rounded-pill shadow-sm transition-transform duration-300 hover:-translate-y-1">
<i class="fas fa-plus fa-sm me-2"></i> {{ __('admin.add_new_course') }}
</a>
</div>
                    ...
                    @forelse($courses as $course)
                        <tr>
                            ...
                            <td class="text-center py-3 px-4">
                                <a href="{{ route('admin.courses.edit', $course->id) }}" class="btn btn-sm btn-info rounded-pill me-2 text-white">
                    ...
                    @empty
                        <tr>
                            <td colspan="6" class="text-center text-muted py-4">
                                <i class="fas fa-exclamation-circle me-2"></i>{{ __('admin.no_courses_found') }}
                            </td>
                        </tr>
                    @endforelse
                </tbody>
